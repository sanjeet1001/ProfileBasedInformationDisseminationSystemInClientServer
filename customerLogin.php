	...
	<nav class="navbar navbar-light bg-faded" style="background-color: #81F7F3;" role="navigation" >
		...
		<div class="navbar-header navbar-right">
			<ul class="nav navbar-tabs nav-pills">
				<li role="presentation" class="nav-item nav-link"><a href="customerLogin.php" >Home</a></li>
 				<li role="presentation" class="nnav-item nav-link"><a href="#" onclick="showDivComplainStatus()">Complain Status</a></li>
				<li role="presentation" class="nav-item nav-link"><a href="#" onclick="showDivNewComplain()">New Complain</a></li>
...
echo 	"<span style='color:red font'>Hi ".$_SESSION["FName"]."  ".$_SESSION["Uid"]." </span>";
...
<div class=" ShowHide" id="newcomplain">
	<div class="panel panel-default">
	<div class="navbar navbar-light bg-faded" style="background-color: #81F7F3;">	<p class="font" align="center">Complain Form</p> </div>
	<div style="background-color: #CEF6F5;">	
				<table>
			        ...
			        <tr>
			          ...
			          <td>  <textarea class="font1" rows="5" cols="50" name="complainMessage" placeholder="requried field *" required ></textarea></td>
			          ...
			          <!-- fatching Department -->
				        <?php
					        ...
					        echo '<td>  <select name="department" class="font">';
...
<div class=" ShowHide" id="complainstatus">
	<div class="panel panel-default">
	<div class="navbar navbar-light bg-faded" style="background-color: #81F7F3;">	<p class="font" align="center">Your Complains and Complain Status</p> </div>
	<div style="background-color: #CEF6F5;">	
				<table>
			        <tr style="border-bottom: 3pt solid red;">
			        <td class="font"><b>Serial No</b></td>
			          <td class="font"><b>Comp No</b></td>
			          <td class="font"><b>Date</b></td>
			          <td class="font"><b>Complain</b></td>
			          <td class="font"><b>Status</b></td>
			          ...
			          <!-- fatching Department -->
				        <?php
				        	$sno = 1;
				        	include ("includes/connection.php"); 
				        	$result2 = mysqli_query($conn,"SELECT * FROM newcomplain");
					        	while($row = mysqli_fetch_array($result2)) {
					        		if($row['Uid']==$_SESSION["Uid"])
					        		echo '<tr  style="border-bottom: 1pt solid green;">
					        			<td class="font">'.$sno.
					        			'</td>
					        			 <td class="font">'.$row['ComplainId'].
					        			'</td>
					        			<td class="font">'.$row['ComplainDate'].
					        			'</td>
					        		<td class="font"><textarea readonly rows="2" cols="25">'.$row['ComplainMessage'].'</textarea>
					        			</td>
					        			<td class="font">'.$row['Status'].
					        			'</td>
					        		</tr>';
					        		$sno++;
								}
	...
	<script>
		function showDivNewComplain()
		{
			...
			document.getElementById("complainstatus").style.display = "none";
			document.getElementById("newcomplain").style.display = "block";
		}
	</script>

	<script>
		function showDivComplainStatus()
		{
			document.getElementById("ex").style.display = "none";
			document.getElementById("newcomplain").style.display = "none";
			document.getElementById("complainstatus").style.display = "block";
		}
	</script>
